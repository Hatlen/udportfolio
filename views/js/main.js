...
var pizzaElementGenerator = (function() {
  var pizzaContainerBase  = document.createElement("div");
  var pizzaImageContainerBase = document.createElement("div");
  var pizzaImageBase = document.createElement("img");
  var pizzaDescriptionContainerBase = document.createElement("div");

  pizzaContainerBase.classList.add("randomPizzaContainer");
  pizzaContainerBase.style.width = "33.33%";
  pizzaContainerBase.style.height = "325px";
  pizzaImageContainerBase.classList.add("col-md-6");
  pizzaDescriptionContainerBase.classList.add("col-md-6");
  pizzaImageBase.src = "images/pizza.png";
  pizzaImageBase.classList.add("img-responsive");
  ...
  return function(i) {
    ...
    pizzaContainer  = pizzaContainerBase.cloneNode();
    pizzaImageContainer = pizzaImageContainerBase.cloneNode();
    pizzaImage = pizzaImageBase.cloneNode();
    pizzaDescriptionContainer = pizzaDescriptionContainerBase.cloneNode();
...
var tempPizzaHolder = document.createDocumentFragment();
for (var i = 2; i < 100; i++) {
  tempPizzaHolder.appendChild(pizzaElementGenerator(i));
}
document.getElementById("randomPizzas").appendChild(tempPizzaHolder);
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var base_elem = document.createElement('img');
  var tempElementHolder = document.createDocumentFragment();
  for (var i = 0; i < 200; i++) {
    var elem = base_elem.cloneNode();
    ...
    tempElementHolder.appendChild(elem);
  }
  document.querySelector("#movingPizzas1").appendChild(tempElementHolder);
  updatePositions();
});
